...
class GroundedCKYEncoder(nn.Module):
    ...
    def forward(self, hidden_states, attention_mask, pad_start=None):
        ...
        root_answers = torch.zeros(batch_size, 512).float().to(hidden_states.device)
        ...
        for i, layer_module in enumerate(self.layer[:num_layers]):
            ...
            print(root_answers.shape, update_root_indices_mask.shape, answer.shape)
        ...
        dump_file = open("/home2/mrbarnes/gp1/dump_file_glt_big.txt", "ab")
