...
PROBING_TASK=nli-prob-prep      # nli-prob-{negation, prep, spatial, quant, comp}
EXP_NAME=mnli-baseline-projection
RUN_NAME=probe

MODEL_DIR="/home2/mrbarnes/gp1/jiant/probe-nli-classifier-projection/train"                        # path to trained NLI classifier directory
